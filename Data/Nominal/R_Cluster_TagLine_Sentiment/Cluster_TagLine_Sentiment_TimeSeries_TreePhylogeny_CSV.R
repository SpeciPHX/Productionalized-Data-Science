...
#dissimilarity(x = top.words.movies.tdm, y = -years.mds.solution, method = "cosine")
years.dissimilarity.matrix <- 
...
#lay <- wordlayout(x, y, w, cex = 1, rotate90 = FALSE, xlim = c(-0.085,0.085), ylim = c(-0.085,0.085)) 
