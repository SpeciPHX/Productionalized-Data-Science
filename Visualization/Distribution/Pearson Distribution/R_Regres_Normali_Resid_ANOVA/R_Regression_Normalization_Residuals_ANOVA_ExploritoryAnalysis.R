...
#http://127.0.0.1:26749/graphics/c7a13f68-267c-4325-9ecd-5e7ca5f3bacb.pngcol = "violet", las = 1))
#par(mar = c(1, 1, 1, 1))
...
dodgers$training_test <- sample(training_test) # random permutation par(mar = c(1, 1, 1, 1))
